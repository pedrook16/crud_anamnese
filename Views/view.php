		...
		<div class="box">			
            ...
            <div class="box-tools">
                ...
                <div class="box-body">
					...
					<input type="radio" disabled name="response" <?php echo $info['response'] == '1' ? 'checked' : ''; ?> value="true" id="yes">
					<label for="no">Não</label>
					<input type="radio" disabled name="response" <?php echo $info['response'] == '0' ? 'checked' : ''; ?> value="false" id="no" > 
			</div>
		</div>
	</form>
